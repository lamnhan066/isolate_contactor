...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    fibonacciRescusive(n) {
      ...
      if (n <= 2)
        return 1;
      return A.fibonacciRescusive(n - 1) + A.fibonacciRescusive(n - 2);
    },
  ...
  A.IsolateException.prototype = {
    toJson$0() {
      var t1 = type$.String;
      return B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["$IsolateException", A.LinkedHashMap_LinkedHashMap$_literal(["error", J.toString$0$(this.error), "stack", this.stack.toString$0(0)], t1, t1)], t1, type$.Map_String_String), null);
    }
  };
  ...
  A.main_closure0.prototype = {
    ...
    $call$body$main_closure(message) {
      var $async$goto = 0,
        ...
        err, stack, exception, t1, completer;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              completer.future.then$1$2$onError(new A.main__closure(), new A.main__closure0(), type$.void);
              try {
                J.complete$1$z(completer, A.fibonacciRescusive(A._asInt(message == null ? type$.Object._as(message) : message)));
              } catch (exception) {
                err = A.unwrapException(exception);
                stack = A.getTraceFromException(exception);
                t1 = new A.IsolateException(err, stack).toJson$0();
                $.$get$_context().callMethod$2("postMessage", [t1]);
              }
              // implicit return
  ...
  A.main__closure.prototype = {
    call$1(value) {
      $.$get$_context().callMethod$2("postMessage", [value]);
      return null;
    },
    $signature: 6
  };
  A.main__closure0.prototype = {
    call$2(err, stack) {
      ...
      t1 = new A.IsolateException(t1, type$.StackTrace._as(stack)).toJson$0();
      $.$get$_context().callMethod$2("postMessage", [t1]);
      return null;
    },
    $signature: 23
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 24);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 25);
  })();
