      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = J.getInterceptor$ns(message);
              result = A.LinkedHashMap_LinkedHashMap$_literal(["a", A._asDouble(t1.$mul(message, 1.112)), "b", A._asDouble(t1.$mul(message, 1.112))], type$.String, type$.double);
